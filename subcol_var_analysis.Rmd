...
gam_c_global <- gam(prod~s(pa_ratio)+s(mean_slope)+ s(adjust_mean_elev) +s(mean_aspect, bs="cc") +s(mean_solar) +s(mean_wind)+s(flood_risk_trans)+skua50_yn+season+s(subcol, bs="re"), data=all_dat_scale[all_dat_scale$col=="croz",], select=TRUE, method="ML")
