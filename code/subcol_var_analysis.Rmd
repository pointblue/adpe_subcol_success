...
gam_simpl <- gam(prod~s(pa_ratio, k=k, bs="cs")+s(adjust_mean_elev,k=k, bs="cs")+s(mean_aspect,k=8,bs="cc")+s(mean_wind,k=k, bs="cs")+season,data=dat, method = "REML")
summary(gam_simpl)
plot.gam(gam_simpl, shade=TRUE, pages=1, scale=0)
